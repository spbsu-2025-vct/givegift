...
1. Войдя в аккаунт, пользователь попадает на страницу избранного
2. В этот же момент с backend'а подгружается избранные товары
...
2. Там можно проделать CRUD операции над избранным, товарами и интересами
3. После проделанных операций изменения применяются и админ панель обновляется
